...
class Graph {
    ...
    // Implement graph traversal methods (DFS, BFS) here
    ...
    public static void main(String[] args) {
        ...
        System.out.println(graph.adjacencyList.values());

        // Example usage: Add more vertices and edges, perform traversals
    }
}
